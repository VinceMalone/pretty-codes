...
export interface ScopeNameInfo {
	/**
	 * If set, this is the id of an ILanguageExtensionPoint. This establishes
	 * the mapping from a MonacoLanguage to a TextMate grammar.
	 */
	language?: LanguageId;
...
export interface SimpleLanguageInfoProviderConfig {
	grammars: { [scopeName: ScopeName]: ScopeNameInfo };
